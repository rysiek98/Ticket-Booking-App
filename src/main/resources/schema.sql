...
CREATE TABLE tickets (id bigint GENERATED BY DEFAULT AS IDENTITY,type varchar(30), price float NOT NULL, guest_id bigint, timetable_id bigint, PRIMARY KEY (id))
