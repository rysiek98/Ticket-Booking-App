...
CREATE TABLE tickets (id bigint GENERATED BY DEFAULT AS IDENTITY,type varchar(30), price FLOAT NOT NULL, seat_number INTEGER NOT NULL, guest_id bigint, timetable_id bigint, PRIMARY KEY (id))
CREATE TABLE timetables (id bigint GENERATED BY DEFAULT AS IDENTITY, guests_number INTEGER NOT NULL,session_time TIME, session_date DATE, movie_id bigint, room_id bigint, PRIMARY KEY (id))
