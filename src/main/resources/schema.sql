...
CREATE TABLE tickets (id bigint GENERATED BY DEFAULT AS IDENTITY,ticket_type VARCHAR(30), price FLOAT NOT NULL, seat_number INTEGER NOT NULL,session_date DATE, session_time TIME, guest_id bigint, screening_id bigint, PRIMARY KEY (id))
